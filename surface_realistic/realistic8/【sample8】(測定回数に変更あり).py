    ...
    for num in range(round_sur+1):
        for i in range(code_distance-2):
            for j in range(-1,code_distance-1):
                if num == round_sur:
                    if (i+j) % 2 == 0:
                        gp_X.add_edge((num,i,j),(num,i+1,j+1),weight=-math.log(2*p_list[3]+p_list[1]))
                    if (i+j) % 2 == 1:
                        gp_X.add_edge((num,i+1,j),(num,i,j+1),weight=-math.log(2*p_list[3]+p_list[1]))
                elif num == round_sur+1:
                    if (i+j) % 2 == 0:
                        gp_X.add_edge((num,i,j),(num,i+1,j+1),weight=-math.log(p_list[5]))
                    if (i+j) % 2 == 1:
                        gp_X.add_edge((num,i+1,j),(num,i,j+1),weight=-math.log(p_list[5]))
                else:
                    if (i+j) % 2 == 0:
        ...
        for i in range(-1,code_distance-1):
            for j in range(code_distance-2):
                if num == 0:
                    ...
                    if (i+j) % 2 == 0:
                        gp_Z.add_edge((num,i+1,j),(num,i,j+1),weight=-math.log((round_sur-1)*(p_list[0]+2*p_list[5])+p_list[0]))
                else:
                    if (i+j) % 2 == 1:
                        gp_Z.add_edge((num,i,j),(num,i+1,j+1),weight=-math.log(p_list[2]+2*p_list[5]))
                    if (i+j) % 2 == 0:
                        gp_Z.add_edge((num,i+1,j),(num,i,j+1),weight=-math.log(p_list[2]+2*p_list[5]))
    ...
    for num in range(2):
        ...
        for i in range(-1,code_distance):
            if num == 0:
                if i % 2 == 0:
                    if i == code_distance-1:
                        gp_Z.add_edge('external_Z',(num,i,code_distance-2),weight=-math.log((round_sur-1)*(p_list[0]+p_list[5])+p_list[0]))
                    else:
                        gp_Z.add_edge('external_Z',(num,i,code_distance-2),weight=-math.log((round_sur-1)*(p_list[0]+2*p_list[5])+p_list[0]))
                if i % 2 == 1:
                    if i == -1:
                        gp_Z.add_edge('external_Z',(num,i,0),weight=-math.log((round_sur-1)*(p_list[0]+p_list[5])+p_list[0]))
                    else:
                ...
                if i % 2 == 0:
                    if i == code_distance-1:
                        ...
                        gp_Z.add_edge('external_Z',(num,i,code_distance-2),weight=-math.log(2*(p_list[2]+p_list[5])))
                if i % 2 == 1:
                    if i == -1:
                        gp_Z.add_edge('external_Z',(num,i,0),weight=-math.log(p_list[2]+p_list[5]))
                    else:
                        gp_Z.add_edge('external_Z',(num,i,0),weight=-math.log(2*(p_list[2]+p_list[5])))
